...
def labelize_data(movie_path, output_path, step_size=1):
...
if __name__ == '__main__':
    ...
    test_ouput_path = '../../ground_truth/Muppets-02-01-01.txt'
    step = 12
    labelize_data(movie_path=test_movie_path, output_path=test_ouput_path, step_size=step)
